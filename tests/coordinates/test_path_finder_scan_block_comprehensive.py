...
def test_path_finder_scan_block_mixed_sequence_classes_and_repeats():
    sections = [
        ...
        DummySection(
            kind="accelerate", start=(0.0, 0.0), stop=(1.0, 0.0), speed=0.5, margin=0.1
        ),
        DummySection(
            kind="line",
            start=(0.0, 0.0),
        ...
        DummySection(
            kind="decelerate", start=(0.0, 0.0), stop=(1.0, 0.0), speed=0.5, margin=0.1
        ),
        DummySection(
            kind="turn",
            start=(1.1, 0.0),
        ...
        DummySection(
            kind="accelerate", start=(1.0, 0.2), stop=(0.0, 0.2), speed=0.5, margin=0.1
        ),
        DummySection(
            kind="line",
            start=(1.0, 0.2),
