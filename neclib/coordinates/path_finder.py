__all__ = ["PathFinder", "StandbyPosition"]
...
class StandbyPosition:
    def standby_position(
        ...
        *,
        ...
        Examples
        --------
        >>> standby = neclib.coordinates.StandbyPosition()
        >>> standby.standby_position(start=(30, 50), end=(32, 50), unit="deg")
