...
from neclib import config, utils
from neclib.core.configuration import Configuration
from neclib.core.normalization import partial
...
class DeviceBase(ABC):
    ...
    _is_simulator: ClassVar[bool] = False
